...
Com base numa análise inicial, foi constatado que a massa de latências está entre 0 e 21 para a mínima e 0 e 30 para a máxima, valores fora desses intervalos são poucos e extremos e cabe a um analista avaliar estes casos.
...
<center>
```{r, echo=FALSE}
pander::pander(tab_bi(massa$p05))
```
</center>
